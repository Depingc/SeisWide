...
protected:
	...
	public:
		...
		static int raw_sfile_read(dcr_stream_obj *obj, void *buf, size_t size, size_t cnt)
		{	return (int) ((CxFile*)obj)->Read(buf,size,cnt); }

		static int raw_sfile_write(dcr_stream_obj *obj, void *buf, size_t size, size_t cnt)
		{	return (int) ((CxFile*)obj)->Write(buf,size,cnt); }
