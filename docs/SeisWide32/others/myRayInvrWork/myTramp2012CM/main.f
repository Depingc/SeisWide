...
c 
      program main
c
c.....Added anisotropy(1:player) by Deping, Dec. 21, 2009
      include 'tramp.par'
c                
...
c
     ...
     +     anisotropy/player*0./,ang_print/-9999./
...
c        open(unit=20, file='v.in', status='old')
        iunit=20
      end if
c
...
c
	...
	read(iunit, end=7999)(anisotropy(icont),icont=1,nlayer)
	
7999	print *, 'ncont,nlayer: ',ncont,nlayer
...
C......may have problem since I changed from f7.2  to f10.4.... Deping, Feb 2009           
385        format(10f10.4)
           i=i+1 
           go to 395
399        nzf=i-1
...
c
            do 90 ir=1,nrayr
               ...
               vp(1,1)=0.0
               vs(1,1)=0.0
               vp(1,2)=vel(xshotr,zshotr, abs(ar(1,2)) )
