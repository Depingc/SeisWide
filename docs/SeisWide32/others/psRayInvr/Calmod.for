...
c
     ...
     +     zsmth(pnsmth)
      integer poisb(papois),poisl(papois)
      include 'rayinvr.com'
      iflagm=0
      idvmax=0
      idsmax=0
c
	print *,'before 10, ncont,ppcntr,xm(i,j),xmax'
...
155        format(i2,1x,f7.2/i2,1x,f7.2/3x,i7)
           ...
           if(i.eq.nlayer) write(12,165) i,xmax,0,z2
...
c                 
999   write(6,900)
900   format(/'***  error in velocity model in calmod ***'/)
      iflagm=1
      return
      end         
