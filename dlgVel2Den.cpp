// dlgVel2Den.cpp : implementation file
//
...
CdlgVel2Den::CdlgVel2Den(CWnd* pParent /*=NULL*/)
	: CDialog(CdlgVel2Den::IDD, pParent)
	, m_denMax(0)
{
	//{{AFX_DATA_INIT(CdlgVel2Den)
	m_d1 = 0.0f;
	m_d2 = 0.0f;
	m_d3 = 0.0f;
	m_d4 = 0.0f;
...
void CdlgVel2Den::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CdlgVel2Den)
...
BEGIN_MESSAGE_MAP(CdlgVel2Den, CDialog)
	//{{AFX_MSG_MAP(CdlgVel2Den)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CdlgVel2Den message handlers
